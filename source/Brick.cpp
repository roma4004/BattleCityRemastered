...
Brick::Brick(const Rectangle& rect, int* windowBuffer, size_t windowWidth, size_t windowHeight,
			 std::shared_ptr<EventSystem> events)
	: BaseObj({rect.x, rect.y, rect.w - 1, rect.h - 1}, 0x924b00, 0, 15), _windowWidth(windowWidth),
