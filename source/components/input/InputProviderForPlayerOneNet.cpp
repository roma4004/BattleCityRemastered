	...
	: _events{std::move(events)}
{
	...
	_events->AddListener("ServerReceive_A_Pressed", _name, [&btn = _playerKeys]() { btn.left = true; });
	_events->AddListener("ServerReceive_A_Released", _name, [&btn = _playerKeys]() { btn.left = false; });
	_events->AddListener("ServerReceive_S_Pressed", _name, [&btn = _playerKeys]() { btn.down = true; });
	_events->AddListener("ServerReceive_S_Released", _name, [&btn = _playerKeys]() { btn.down = false; });
	_events->AddListener("ServerReceive_D_Pressed", _name, [&btn = _playerKeys]() { btn.right = true; });
	_events->AddListener("ServerReceive_D_Released", _name, [&btn = _playerKeys]() { btn.right = false; });
	_events->AddListener("ServerReceive_Space_Pressed", _name, [&btn = _playerKeys]() { btn.shot = true; });
