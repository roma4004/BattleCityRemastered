...
BOOST_CLASS_EXPORT_IMPLEMENT(TankOnOff);

TankOnOff::TankOnOff() : Command{CommandType::TANK_ON_OFF} {}

TankOnOff::TankOnOff(const buuid uuid, const bool isEnable, std::string name)
	: Command{CommandType::TANK_ON_OFF}, _uuid{uuid}, _isEnable{isEnable}, _name{std::move(name)} {}
